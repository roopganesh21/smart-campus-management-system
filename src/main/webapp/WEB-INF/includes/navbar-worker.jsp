...
<!-- Premium Worker Header/Navbar CSS -->
<style>
    .worker-header {
    ...
    .avatar-initials-worker:hover {
        transform: scale(1.05);
    }
</style>

<div class="worker-header d-flex justify-content-between align-items-center flex-wrap gap-3">
    <!-- Left Hand: Title / Context Tag -->
    <div class="d-flex align-items-center">
        <h5 class="fw-bold text-dark mb-0 me-3">Smart Campus Worker Console</h5>
        <span class="badge bg-warning-subtle text-warning fw-semibold px-2 py-1 rounded">Service Crew</span>
    </div>
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="avatar-initials-worker text-white fw-bold d-inline-flex align-items-center justify-content-center rounded-circle me-3" title="Worker Profile">
            <c:choose>
